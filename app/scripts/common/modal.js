...
define(['jquery', 'utils'], function($, S){
    ...
    that.confirm = function(/*str, labelCancel, labelOk, cb*/) {
        ...
        return that.dialog(str, [{
            ...
            'close': false,
            'header': '信息提示',
            'classes': 'modal_confirm modal_alert_confirm'
        });
    };
    ...
    that.dialog = function(str, handlers, options) {
        ...
        parts.push("<div class='modal-body'><span class='modal-alert-ico'></span><span class='modal-alert-content'></span></div>");
        if (buttons) {
        ...
        modalDiv.find(".modal-alert-content").html(str);
        /* ^生成jQuery modal对象, 并且塞进内容*/
        ...
        modalDiv.on('hidden', function() {
            /* fixed iframe input focus bug */
            if(modalDiv.find('iframe').length){
